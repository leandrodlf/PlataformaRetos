...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        retos_data = [
            ...
            # 17 RETOS FÁCILES ADICIONALES (Total: 20 fáciles)
            {
                'titulo': 'Suma básica',
            ...
            # 19 RETOS MEDIOS ADICIONALES (Total: 20 medios)
            {
            ...
            # 19 RETOS DIFÍCILES ADICIONALES (Total: 20 difíciles)
            {
        ...
        for reto_data in retos_data:
            ...
            if created:
                ...
                # Crear alternativas si el reto las necesita
